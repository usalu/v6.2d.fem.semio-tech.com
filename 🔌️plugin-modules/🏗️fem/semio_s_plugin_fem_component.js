...
_trampoline26.fnName = 'semio:framework/pure@1.0.0#log';
...
_trampoline28.fnName = 'wasi:random/insecure-seed@0.2.9#insecureSeed';
...
async function stepJob(arg0, arg1) {
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    getCallbackFn: () => callback_4,
    callbackFnName: callback_4,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  });
...
async function cancelJob(arg0) {
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    getCallbackFn: () => callback_5,
    callbackFnName: callback_5,
    errHandling: 'none',
    callingWasmExport: true,
  });
...
async function takeSegmentedDownloadChunk(arg0, arg1) {
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    getCallbackFn: () => callback_6,
    callbackFnName: callback_6,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  });
...
async function checkpoint() {
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    getCallbackFn: () => callback_7,
    callbackFnName: callback_7,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  });
...
async function restore(arg0) {
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    getCallbackFn: () => callback_8,
    callbackFnName: callback_8,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  });
...
async function describe() {
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    getCallbackFn: () => callback_9,
    callbackFnName: callback_9,
    errHandling: 'none',
    callingWasmExport: true,
  });
...
const trampoline27 = waitableSetPoll.bind(
null,
{
  componentIdx: 0,
  isAsync: false,
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    ...
    const module1 = base64Compile('');
    const module2 = base64Compile('');
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      ...
      '[export]semio:framework/describe@1.0.0': {
        '[task-return]describe': exports0['8'],
      },
      '[export]semio:framework/jobs@1.0.0': {
        ...
        '[task-return]take-segmented-download-chunk': exports0['4'],
      },
      '[export]semio:framework/reactor@1.0.0': {
        '[task-return]poll': exports0['5'],
        '[task-return]stage-cold-pair-page': exports0['7'],
        '[task-return]stage-command-page': exports0['6'],
      },
    ...
    callback_0 = WebAssembly.promising(exports1['[callback][async-lift]semio:framework/reactor@1.0.0#stage-command-page']);
    callback_0.fnName = "exports1['[callback][async-lift]semio:framework/reactor@1.0.0#stage-command-page']";
    
    
    callback_1 = WebAssembly.promising(exports1['[callback][async-lift]semio:framework/reactor@1.0.0#stage-cold-pair-page']);
    callback_1.fnName = "exports1['[callback][async-lift]semio:framework/reactor@1.0.0#stage-cold-pair-page']";
    
    
    callback_2 = WebAssembly.promising(exports1['[callback][async-lift]semio:framework/reactor@1.0.0#poll']);
    callback_2.fnName = "exports1['[callback][async-lift]semio:framework/reactor@1.0.0#poll']";
    
    
    callback_3 = WebAssembly.promising(exports1['[callback][async-lift]semio:framework/jobs@1.0.0#start-job']);
    callback_3.fnName = "exports1['[callback][async-lift]semio:framework/jobs@1.0.0#start-job']";
    
    
    callback_4 = WebAssembly.promising(exports1['[callback][async-lift]semio:framework/jobs@1.0.0#step-job']);
    callback_4.fnName = "exports1['[callback][async-lift]semio:framework/jobs@1.0.0#step-job']";
    
    
    callback_5 = WebAssembly.promising(exports1['[callback][async-lift]semio:framework/jobs@1.0.0#cancel-job']);
    callback_5.fnName = "exports1['[callback][async-lift]semio:framework/jobs@1.0.0#cancel-job']";
    
    
    callback_6 = WebAssembly.promising(exports1['[callback][async-lift]semio:framework/jobs@1.0.0#take-segmented-download-chunk']);
    callback_6.fnName = "exports1['[callback][async-lift]semio:framework/jobs@1.0.0#take-segmented-download-chunk']";
    
    
    callback_7 = WebAssembly.promising(exports1['[callback][async-lift]semio:framework/checkpoint@1.0.0#checkpoint']);
    callback_7.fnName = "exports1['[callback][async-lift]semio:framework/checkpoint@1.0.0#checkpoint']";
    
    
    callback_8 = WebAssembly.promising(exports1['[callback][async-lift]semio:framework/checkpoint@1.0.0#restore']);
    callback_8.fnName = "exports1['[callback][async-lift]semio:framework/checkpoint@1.0.0#restore']";
    
    
    callback_9 = WebAssembly.promising(exports1['[callback][async-lift]semio:framework/describe@1.0.0#describe']);
    callback_9.fnName = "exports1['[callback][async-lift]semio:framework/describe@1.0.0#describe']";
